...
schema. For the project you actually launch on: `npx supabase db push` (42 migrations as of launch),
...
SECURITY DEFINER functions, triggers and RLS policies against a real Postgres. **117 tests, all
