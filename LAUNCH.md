...
schema. For the project you actually launch on: `npx supabase db push` (35 migrations as of launch),
...
SECURITY DEFINER functions, triggers and RLS policies against a real Postgres. **62 tests, all
