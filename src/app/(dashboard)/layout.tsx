      ...
      <header className="border-b">
        <div className="mx-auto flex h-14 w-full max-w-5xl items-center gap-4 px-6">
          ...
          <nav className="text-muted-foreground flex min-w-0 flex-1 items-center gap-4 overflow-x-auto text-sm whitespace-nowrap">
            ...
            <Link href="/seller/launch" className="hover:text-foreground shrink-0">
              Launch
            </Link>
            ...
            <Link href="/seller/drops" className="hover:text-foreground shrink-0">
              Batches
            </Link>
            <Link href="/seller/events" className="hover:text-foreground shrink-0">
              Events
            </Link>
            <Link href="/seller/story" className="hover:text-foreground shrink-0">
              Your story
            </Link>
            <Link href="/seller/questions" className="hover:text-foreground shrink-0">
              Updates
            </Link>
